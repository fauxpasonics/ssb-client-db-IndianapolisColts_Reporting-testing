...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__4D94879B] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[User] ADD CONSTRAINT [PK__User__3214EC07D0E67DC5] PRIMARY KEY CLUSTERED  ([Id])
GO
