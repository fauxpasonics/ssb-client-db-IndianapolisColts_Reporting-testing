...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__44FF419A] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Contact] ADD CONSTRAINT [PK__Contact__3214EC0700D34AC5] PRIMARY KEY CLUSTERED  ([Id])
GO
