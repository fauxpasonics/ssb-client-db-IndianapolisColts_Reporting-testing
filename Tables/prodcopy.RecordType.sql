...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__RecordTyp__copyl__4AB81AF0] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[RecordType] ADD CONSTRAINT [PK__RecordTy__3214EC070200A106] PRIMARY KEY CLUSTERED  ([Id])
GO
