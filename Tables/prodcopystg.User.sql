...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__5070F446] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[User] ADD CONSTRAINT [PK__User__3214EC07218FFA76] PRIMARY KEY CLUSTERED  ([Id])
GO
