...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__3C69FB99] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Account] ADD CONSTRAINT [PK__Account__3214EC07A25B8490] PRIMARY KEY CLUSTERED  ([Id])
GO
